...
CREATE TABLE `staff_shift` (
  ...
  CONSTRAINT `staff_shift_ibfk_1` FOREIGN KEY (`staff_id`) REFERENCES `staff` (`staff_id`),
  CONSTRAINT `staff_shift_ibfk_2` FOREIGN KEY (`shift_id`) REFERENCES `shift` (`shift_id`)
